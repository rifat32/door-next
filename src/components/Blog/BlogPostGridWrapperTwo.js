...
const BlogPostGridWrapperTwo = ({ columns }) => {
  const params = {
    loop: false,
    slidesPerView: 1,
    autoplay: {
        ...
        <div className="blog-post">
          ...
          <div className="blog-post__content">
            <div className="blog-text">
              <h6 className="blog-title blog-title--style2">
                <Link href="/blog/post-left-sidebar">
        ...
        <div className="blog-post">
          <div className="blog-post__image">
            <div className="fit-videos">
              <div className="fluid-width-video-wrapper fluid-width-video-wrapper--style2">
                <iframe
...
export default BlogPostGridWrapperTwo;
